 ...
 */
template <class TypeGuess> int construct_guess (TypeGuess ***guess, uint32_t alg, Matrix *m, Matrix * ct, uint32_t n_m, uint32_t bytenum, uint32_t R, uint32_t pos, uint16_t * sbox, uint32_t n_keys, int8_t bit);
